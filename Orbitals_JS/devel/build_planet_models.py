...
Run with Blender:
  blender --background --python Orbitals_JS/devel/build_planet_models.py
"""
...
# Folder containing the Orbitals textures and generated GLBs.
BASE_DIR = Path(r"c:\Portable\0Networkshare\GitHub\GamesAndStuff_JS\Orbitals_JS\devel")

UPSCALED_DIR = BASE_DIR / "upscaled"
ASSETS_DIR = UPSCALED_DIR if UPSCALED_DIR.exists() else BASE_DIR
MODELS_DIR = BASE_DIR

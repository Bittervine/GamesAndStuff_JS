...
export const TEST_SHARDS = Object.freeze({
    "shared-1": Object.freeze([
            ...
            "Palette Builder hashes Blob-backed resource reads",
            "atlas Python tooling regression suite",
            ...
            "gamepad jump does not bypass title menu",
    ...
    "shared-2": Object.freeze([
            ...
            "credits roll and invisible cutscene speaker",
    ...
    "editor-2": Object.freeze([
            ...
            "character authored atlas variants",
            "data-driven wizard walk animation",
    ...
    "game-1": Object.freeze([
            ...
            "moving-platform translation easing",
            "swinging moving platform",
            "swinging moving-platform swept hazards",
            "moving-platform interaction regressions",
            "enemy blockable slope standability",
            ...
            "hunter treats moving platform as disconnected",
            "signal-triggered moving platform",
            "one-shot proximity signal trigger",
            "keyhole consumes key and triggers platform",
            "vanishing moving platforms always recover",
            "embedded enemy recovery and moving-platform reset recovery",
            "moving platforms sweep projectiles",
            "Score HUD and treasure chest collection",
            "data-driven enemy loot and coin pickup",
            "Overdrive, Shield, and wrench power-up arsenal",
            "reserved level fixtures",
            "rocket-fuel governed Flight mode",
            "scripted mailbox letter",
            "proximity-triggered world text",
            "one-shot location thought trigger",
            "modal scripted cutscene trigger",
            "scripted portal entrance",
            "scripted portal exit",
            "invisible portal points",
            "skeletons are larger in shipped levels",
            "persistent player progression upgrades",
            ...
            "flying bomber deterministic meander"
    ]),
    "game-2": Object.freeze([
            ...
            "enemy navigation exposed surface walk regions",
            "enemy navigation stride-arc and legacy step methods",
            "enemy navigation simulation verification",
            "baked navigation graph directional transitions",
            "navigation maze detour route",
            "hunter enemy jump and attack positioning",
            "hunter melee chooses nearest attack-ready spacing",
            ...
            "level_t11 lower-pillar hunter uses overlapping-floor run-up",
            "level_t12 first Fireball Goblin naturally engages and fires",
            "hunter restored pursue state normalizes like SDL",
            ...
            "human hunter approaches blocked level_t01 pillar",
            "human hunter stops at unreachable level_t01 pillar",
            "hunter return-home reengagement cooldown",
    ...
    "game-3": Object.freeze([
            ...
            "hunter vertical one-way jump and distance watchdog",
            ...
            "hunters do not walk off internal one-way seams",
            "player can drop through one-way platforms",
            "ground enemies walk up small steps",
            "character enemy runtime loader matches SDL semantics",
            "generic enemy legacy support selection matches SDL",
            ...
            "passive enemy stays passive when damaged",
            "airborne enemy defers death until landing",
            "airborne hunter hurt preserves navigation traversal",
            "enemy contact damage uses independent invulnerability",
            "character enemy melee attack",
            "attack start preserves SDL handoff timing",
            "combat profile cannot shorten SDL attack duration",
            ...
            "projectile archetypes compose visual, spread, homing, and rotation behavior",
            ...
            "Hobgoblin musket mortar area damage",
            ...
            "Big Bomb reactive objects receive area damage once",
            "headless stepping and floor collision",
            "charged horizontal player lunge",
            "closed sloped stair body does not conveyor player downhill",
            "player follows steep walkable bridge ramps while running",
            "swept support uses up-to-down crossing not colour priority",
            "revision 403 collision and support contracts",
    ...
    "game-4": Object.freeze([
            ...
            "offscreen rocket lifetime explosions are culled",
            "homing rockets use fixed target range",
            ...
            "water regions, swimming and fall damping",
            ...
            "camera edge catch-up keeps wizard visible",
            "four-sided world-bounds kill border and no fallback target",
    ...
    "generator-foundation": Object.freeze([
            ...
            "asset generation capability autotagging",

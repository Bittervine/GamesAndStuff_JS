...
The wizard can conjure a rocket onto his back - he will do that automatically a few seconds after it has been spent.  
He will typically jump along a standard parabola and if he set of the rocket mid air (with a second jump click). It will boost the jump along its current movment vector. 
A second click will disconnect him from the robot and he will fall back to the ground while the rocket continue and crash into whatever it is heading towards.  
The game is written in HTML+JS.  We will probably try to animate parts of him like his beard and hair while his body is built up from sprites legs, arms torso and head that we will rig.
He will usually be running froim left to right but we can easily mirror all assets.

...
|---|---|---|
| `src/core/simulation.js` | PORTABLE CORE | Authoritative fixed-step state, player physics, collisions, weapons, enemies, story state, level runtime conversion, serialization, and update order. |

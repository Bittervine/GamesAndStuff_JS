# ThoriumGap Implementation Plan
...
- [x] Keep only the main game canvas, HUD canvas, controls, settings dialog, manual button, and `ThoriumGap.js` loader.
...
- [ ] Keep `ThoriumGap.html` static DOM pure 2D by default.

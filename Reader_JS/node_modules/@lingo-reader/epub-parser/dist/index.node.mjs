import { path, camelCase, parsexml } from '@lingo-reader/shared';
import fs, { writeFileSync as writeFileSync$1, existsSync as existsSync$1, mkdirSync as mkdirSync$1, unlink as unlink$1, readFileSync as readFileSync$1 } from 'node:fs';
...
function writeFileSync(file, data, options) {
  {
    writeFileSync$1(file, data, options);
  }
}
...
function existsSync(file) {
  {
    return existsSync$1(file);
  }
}
function mkdirSync(dir, _options) {
  {
    return mkdirSync$1(dir, _options);
  }
}
...
function isNotFontObfuscation(encryptedData) {
...
export { HREF_PREFIX as EPUB_HREF_PREFIX, initEpubFile };

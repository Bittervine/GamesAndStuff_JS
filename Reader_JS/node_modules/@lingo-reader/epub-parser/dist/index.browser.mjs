...
function existsSync(file) {
  {
    return imageRecord[file] !== void 0;
  }
}
...
async function decryptAes(name, symmetricKey, fileData) {
  {
    ...
    const [algoName, bits, mode] = name.split("-");
    if (bits === "192") {
...
const browserUrlCache = /* @__PURE__ */ new Map();
    ...
    if (links) {
      for (const link of links) {
        ...
        if (linkHref.endsWith(".css")) {
          ...
          {
            realPath = browserUrlCache.get(cssName) || URL.createObjectURL(new Blob([fileContent], { type: "text/css" }));
          }
          css.push({
            id: cssName,
            href: realPath
...
class EpubFile {
  constructor(epub, resourceSaveDir = "./images", options = {}) {
    ...
    if (!existsSync(this.resourceSaveDir)) {
      mkdirSync(this.resourceSaveDir);
    }

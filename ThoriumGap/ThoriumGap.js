(function () {
  ...
  function drawTitleGlowTests(cardX, cardY, cardW, cardH) {
    ...
    const samples = [
      { label: 'A', x: cardX + cardW * 0.16, y: cardY + cardH * 0.18, r: 82, fn: function (x, y, r) { drawRadialGradientGlow(x, y, r, 'rgba(255,255,255,0.18)', 'rgba(146,220,255,0.0)', 0.18, 16, 64); } },
      { label: 'B', x: cardX + cardW * 0.50, y: cardY + cardH * 0.18, r: 82, fn: function (x, y, r) { drawDiffuseGlowCircle(x, y, r, '#9dd9ff', 0.12); } },
      { label: 'C', x: cardX + cardW * 0.84, y: cardY + cardH * 0.18, r: 82, fn: function (x, y, r) { drawLayeredFalloffGlow(x, y, r, '#bcecff', 0.12, 48, 2.6, 0.3); } },
      { label: 'D', x: cardX + cardW * 0.16, y: cardY + cardH * 0.74, r: 82, fn: function (x, y, r) { drawMaskedGlow(x, y, r, 'rgba(255,255,255,0.24)', 0.18, 56); } },
      { label: 'E', x: cardX + cardW * 0.50, y: cardY + cardH * 0.74, r: 82, fn: function (x, y, r) { drawRadialGradientGlow(x, y, r, 'rgba(255,255,255,0.12)', 'rgba(146,220,255,0.0)', 0.14, 8, 80); } },
      { label: 'F', x: cardX + cardW * 0.84, y: cardY + cardH * 0.74, r: 82, fn: function (x, y, r) { drawMaskedGlow(x, y, r, 'rgba(255,255,255,0.18)', 0.14, 72); } }
    ];
    hudCtx.save();
    ...
    for (let i = 0; i < samples.length; i++) {
      ...
      hudCtx.fillText(s.label, s.x, s.y - s.r - 10);
    }
    hudCtx.restore();
  }
  ...
  function drawTitle() {
    ...
    drawTitleGlowTests(20, view.h - view.controlsH - 150, Math.min(view.w - 40, 760), 120);
    hudCtx.fillStyle = '#fff';
